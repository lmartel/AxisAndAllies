...
(function(){
    ...
    function loadClasses(){
        ...
        (function(){
            ...
            // Private helper
            function makePayload(hex, arg1, arg2){
                var payload;
                
                // arg2 is asset object
                if(typeof arg2 === "object"){
                    payload = new Payload(arg1, arg2);
                } else if(!arg2){
                    payload = arg1;
                } else {
                    var defaultSz = hex.grid.getHexagonSize() * 1.5;
                    payload = new Payload(arg1, new H$.Asset(arg2, defaultSz, defaultSz));
                }
                if(!payload) payload = new Payload(null, null);
                return payload;
            }

            H$.Hexagon.prototype.setPayload = Hexagon_setPayload;
            function Hexagon_setPayload(arg1, arg2){
                this.payload = makePayload(this, arg1, arg2);
                return this;
            }
            ...
            function Hexagon_pushPayload(arg1, arg2){
                throw "multiple payloads not yet implemented";
                var payload = makePayload(this, arg1, arg2);
                if(!Array.isArray(this.payload)){
                    var old = this.payload;
                    this.payload = [];
                    if(JSON.stringify(old) !== JSON.stringify(makePayload(this, null))) this.payload.push(old);
                }
