    ...
    function loadClasses(){
        ...
        (function(){
            ...
            function Hexagon_getBackgroundImage(){
                var patterns = this.grid.patterns;
                for(var path in patterns){
                    if(!patterns.hasOwnProperty(path)) continue;
                    if(this.fill.indexOf(patterns[path]) !== -1) return path;
                }
                return null;
            }
